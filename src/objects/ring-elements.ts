...
export const all = [1, 2, 3, 4, 5, 6];
export const odd = [1, 3, 5];
export const even = [2, 4, 6];
export const left = [1, 2, 3];
export const right = [4, 5, 6];
export const center = [3, 4];
export const outer = [1, 2, 5, 6];
